    ...
    <>
      <footer className="gradientBg text-tertiary px-5 py-10 max-w-screen-2xl mx-auto ">
        <div className="container mx-auto px-4 ">
          <div className="text-center md:flex flex-wrap justify-between md:pr-12 items-center">
            <div>
              <Link to="/">
                <img
                  src={Logo}
            ...
            <nav>
              <ul className="block text-center space-y-2 md:space-y-0 md:flex md:space-x-36 text-tertiary">
