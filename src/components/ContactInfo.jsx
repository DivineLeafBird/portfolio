        ...
        <div className="flex flex-col gap-4">
          <div className="bg-primary bg-opacity-50 rounded-lg flex flex-col items-center  md:flex-row md:gap-4 p-5">
            ...
            <div className="flex flex-col p-5">
              ...
              <button className="px-4 py-2 rounded-3xl w-1/2 border-solid border-2 border-blue mt-6 outline-none hover:bg-secondary md:transition lg:duration-500 lg:ease-in-out lg:transform lg:hover:-translate-y-1 lg:hover:scale-110">
                <Link
                  to="https://facetime.apple.com/join#v=1&p=PVL1RQ/HEe+qBrL1pkW+ew&k=wgf8RP6jO7aRuPOH5aRe5kWVbl49e7ewI0Lr1jFes4g"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Let's talk
